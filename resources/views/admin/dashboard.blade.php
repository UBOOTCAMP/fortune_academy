            ...
            <div class="card radius-10 w-100">
                ...
                <div class="customers-list p-3 mb-3">
                    <div
                        ...
                        <div class="">
                            <img src="assets/images/avatars/avatar-1.webp" class="rounded-circle" width="46"
                                 height="46" alt=""/>
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="assets/images/avatars/avatar-2.webp" class="rounded-circle" width="46"
                                 height="46" alt=""/>
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="assets/images/avatars/avatar-3.webp" class="rounded-circle" width="46"
                                 height="46" alt=""/>
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="assets/images/avatars/avatar-4.webp" class="rounded-circle" width="46"
                                 height="46" alt=""/>
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="assets/images/avatars/avatar-5.webp" class="rounded-circle" width="46"
                                 height="46" alt=""/>
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="assets/images/avatars/avatar-6.webp" class="rounded-circle" width="46"
                                 height="46" alt=""/>
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="assets/images/avatars/avatar-7.webp" class="rounded-circle" width="46"
                                 height="46" alt=""/>
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="assets/images/avatars/avatar-8.webp" class="rounded-circle" width="46"
                                 height="46" alt=""/>
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="assets/images/avatars/avatar-9.webp" class="rounded-circle" width="46"
                                 height="46" alt=""/>
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                        <div class="">
                            <img src="assets/images/avatars/avatar-10.webp" class="rounded-circle" width="46"
                                 height="46" alt=""/>
                        </div>
                        <div class="ms-2">
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table align-middle mb-0">
                            ...
                            <tr>
                                ...
                                <td>22 Jun, 2020</td>
                                <td class=""><span class="badge bg-light-danger text-danger w-100">Cancelled</span>
                                </td>
                                <td>#149.25</td>
                                <td>
                                    <div class="d-flex order-actions"><a href="javascript:;"
                            ...
                            <tr>
                                ...
                                <td>22 Jun, 2020</td>
                                <td class=""><span class="badge bg-light-warning text-warning w-100">Pending</span>
                                </td>
                                <td>#149.25</td>
                                <td>
                                    <div class="d-flex order-actions"><a href="javascript:;"
